    ...
    int main() {
        ...
        printf("Número de pontos turísticos: %d\n\n\n", pturisticos2);//Imprime o número de pontos turísticos;
            ...
            case 1:// O que deve fazer se a opção 1 for selecionada;
                ...
                {
                    printf("\nPopulação da carta 1 é maior do que a carta 2!\n");
                } else {
                    printf("\nPopulação da carta 2 é maior do que a carta 1!\n");
                }
                ...
                printf("Escolha um dos números acima: ");
                scanf("%d", &opcao3);//Aqui eu uso mais uma variável;
                ...
                {
                    printf("\nDensidade populacional da carta 1 é maior do que a carta 2, carta 2 ganha!\n");
                } else {
                    printf("\nDensidade populacional da carta 2 é maior do que a carta 1, carta 1 ganha!\n");
                }
                ...
                if (area > area2)
                {
                    printf("\nÁrea da carta 1 é maior do que a carta 2!\n");
                } else {
                    printf("\nÁrea da carta 2 é maior do que a carta 1!\n");
                }
                ...
                if (pib > pib2)
                {
                    printf("\nPIB da carta 1 é maior do que a carta 2!\n");
                } else {
                    printf("\nPIB da carta 2 é maior do que a carta 1!\n");
                }
                ...
                {
                    printf("\nPIB per capita da carta 1 é maior do que a carta 2!\n");
                } else {
                    printf("\nPIB per capita da carta 2 é maior do que a carta 1!\n");
                }
                ...
                {
                    printf("\nPontos turísticos da carta 1 é maior do que a carta 2!\n");
                } else {
                    printf("\nPontos turísticos da carta 2 é maior do que a carta 1!\n");
                }
        ...
        case 2://aqui ele diz o que acontece se o usuário selecionar a opção 2;
            ...
            printf("Escolha a primeira propriedade que você quer comparar;\n");
            printf("Escolha a segunda propriedade que você quer comparar;\n");
        ...
        default://aqui ele diz o que acontece se o usuário seleecionar uma  opção que não seja 1, 2, ou 3;
            printf("\nOpção inválida, digite apenas o número 1, 2 ou 3!\n");
        }
